...
export const PRODUCTS_SEED_DATA = [
  ...
  },
  {
    ...
    taglineRo: 'AI copilot pentru scriitori să scrie mai rapid',
    taglineEn: 'AI copilot for writers to write faster',
    taglineIt: 'Copilot AI per scrittori che scrivono più velocemente',
    problemRo:
      'Scriitorii pierd ore luptându-se cu blocajul scrisului, editarea și structurarea ideilor. Procesul de scriere este lent și epuizant.',
    problemEn:
      "Writers waste hours struggling with writer's block, editing and structuring ideas. The writing process is slow and exhausting.",
    problemIt:
      "Gli scrittori sprecano ore lottando con il blocco dello scrittore, l'editing e la strutturazione delle idee. Il processo di scrittura è lento ed estenuante.",
    descriptionRo:
      'Bestseller Copilot este un asistent AI inteligent care ajută scriitorii să scrie mai rapid și mai bine. Analizează stilul tău, sugerează îmbunătățiri și te ghidează prin proces, ca un copilot care înțelege viziunea ta creativă.',
    descriptionEn:
      'Bestseller Copilot is an intelligent AI assistant that helps writers write faster and better. It analyzes your style, suggests improvements and guides you through the process, like a copilot who understands your creative vision.',
    descriptionIt:
      'Bestseller Copilot è un assistente AI intelligente che aiuta gli scrittori a scrivere più velocemente e meglio. Analizza il tuo stile, suggerisce miglioramenti e ti guida nel processo, come un copilota che capisce la tua visione creativa.',
    featuresRo: JSON.stringify([
      'Asistență AI la scriere în timp real',
      'Sugestii de stil și îmbunătățiri',
      'Generare outline și structură',
      'Editare și optimizare text',
      'Analiza consistenței narativei',
      'Suport pentru multiple genuri',
    ]),
    featuresEn: JSON.stringify([
    ...
    featuresIt: JSON.stringify([
      ...
      'Suggerimenti di stile e miglioramenti',
      'Generazione outline e struttura',
      'Editing e ottimizzazione testo',
      'Analisi coerenza narrativa',
      'Supporto multi-genere',
    ]),
